<template>
  <div class="container courseCategory">
...
<script>
  export default {
    ...
    methods: {
      ...
      //获取课程分类列表
      categoryList() {
        this.$http('/admin/course/getCourseCategory', {
          page: this.pageNum,
          size: this.pageSize,
      ...
      save() {
        ...
        this.$http('/admin/course/insertOrUpdateCategory', params).then(res => {
          if (res.code == 0) {
      ...
      remove(pkid){
        this.$confirm('是否删除该分类','提示',{
          ...
          this.$http('/admin/course/deleteCategory',{id:pkid}).then(res=>{
            if(res.code == 0){
