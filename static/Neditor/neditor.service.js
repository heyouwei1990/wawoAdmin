...
UE.Editor.prototype.getActionUrl = function(action) {
    ...
    if (action == 'uploadimage' || action == 'uploadscrawl') {
        return window.URLCONFIG.baseUrl+'/api/img/insertImage?folder=editor' //'http://a.b.com/upload.php';
    } else if (action == 'uploadvideo') {
        return window.URLCONFIG.baseUrl+'/api/img/insertVideo?folder=editor'//'http://a.b.com/video.php';
    } else {
...
window.UEDITOR_CONFIG['imageUploadService'] = function(context, editor) {
    return {
        ...
        headers['Jwt']=window.sessionStorage.getItem('Jwt');
        return data;
      },
      /**
       * 触发startUpload事件时执行
